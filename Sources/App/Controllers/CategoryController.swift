...
final class CategoryController {
	...
	private func itemDataArray(for itemCategoryItemPairs: [(Item, CategoryItem)], req: Request)
	...
	private func itemData(for item: Item, categoryItem: CategoryItem, req: Request)
		throws -> Future<ItemData> {
